...
## Make sam files directory and define sam file output
mkdir -p "${WORKDIR}/sam_files_consensus/"
SAM_OUTPUT="${WORKDIR}/sam_files_consensus/${SAMPLE_ID}_consensus.sam"

## Define temporary and input/output directories for VCFs, consensus reference sequences, and intermediate files
temp_dir="${WORKDIR}/tmp/"
vcf_dir="${WORKDIR}/vcf_files_consensus/"
consensus_dir="${WORKDIR}/consensus_reference_sequences/"
